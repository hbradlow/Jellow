...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.tags'
        db.alter_column('collect_data_rating', 'tags', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Rating.support'
        db.alter_column('collect_data_rating', 'support', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Rating.readability'
        db.alter_column('collect_data_rating', 'readability', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Rating.organization'
        db.alter_column('collect_data_rating', 'organization', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Article.reporter'
        db.add_column('collect_data_article', 'reporter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='n/a', to=orm['profiles.UserProfile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rating.tags'
        db.alter_column('collect_data_rating', 'tags', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Rating.support'
        db.alter_column('collect_data_rating', 'support', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Rating.readability'
        db.alter_column('collect_data_rating', 'readability', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Rating.organization'
        db.alter_column('collect_data_rating', 'organization', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'Article.reporter'
        db.delete_column('collect_data_article', 'reporter_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rating.article'
        db.add_column('collect_data_rating', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collect_data.Article'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rating.article'
        db.delete_column('collect_data_rating', 'article_id')

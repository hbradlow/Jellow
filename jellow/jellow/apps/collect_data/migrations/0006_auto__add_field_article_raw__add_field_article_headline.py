...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.raw'
        db.add_column('collect_data_article', 'raw',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Article.headline'
        db.add_column('collect_data_article', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.raw'
        db.delete_column('collect_data_article', 'raw')

        # Deleting field 'Article.headline'
        db.delete_column('collect_data_article', 'headline')

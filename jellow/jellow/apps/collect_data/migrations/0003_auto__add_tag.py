...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table('collect_data_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('collect_data', ['Tag'])

        # Adding M2M table for field tags on 'Paragraph'
        db.create_table('collect_data_paragraph_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('paragraph', models.ForeignKey(orm['collect_data.paragraph'], null=False)),
            ('tag', models.ForeignKey(orm['collect_data.tag'], null=False))
        ))
        db.create_unique('collect_data_paragraph_tags', ['paragraph_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table('collect_data_tag')

        # Removing M2M table for field tags on 'Paragraph'
        db.delete_table('collect_data_paragraph_tags')
    ...
    models = {
        ...
        'collect_data.paragraph': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['collect_data.Tag']", 'symmetrical': 'False'}),
        ...
        'collect_data.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        },
        'collect_data.tweet': {
